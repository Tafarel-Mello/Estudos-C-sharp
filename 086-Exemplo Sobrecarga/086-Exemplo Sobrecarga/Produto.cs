...
namespace Curso
{
    class Produto
    {
        ...
        public Produto(string nome, double preco, int quantidade) // possibilidade de instaciar com 3 argumentos
        {
            Nome = nome;
            Preco = preco;
        ...
        public Produto(string nome, double preco) // possibilidade de instanciar com apenas 2 argumentos
        {
            Nome = nome;
            Preco = preco;
            Quantidade = 0;
